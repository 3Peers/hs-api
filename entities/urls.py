...
urlpatterns = [
    ...
    path('user/<int:user_id>/experience/', UserExperienceCreateListView.as_view(), name='experience-cl'),
    path('user/<int:user_id>/experiece/<int:pk>/', UserExperienceRUDView.as_view(), name='experience-rud'),

    path('user/<int:user_id>/education/', UserEducationCreateListView.as_view(), name='education-cl'),
    path('user/<int:user_id>/education/<int:pk>/', UserEducationRUDView.as_view(), name='education-rud'),
    ...
    path('job-application/<int:pk>/', JobApplicationRUDView.as_view(), name='job-application-rud'),
